...
class Product (models.Model):
    ...
    unit_price=models.IntegerField(max_length=200,null=True)
    sale_price=models.IntegerField(max_length=200,null=True)
    available_stock=models.IntegerField(max_length=100,null=True)
